...
<div class="content_area container_child">
    ...
    <div class="posts_grand_parent">
        <div class="blog_heading">
            <h1 class="heading_txt"><span>Author: </span><span class="second_span"><?php echo esc_html($author_name); ?></span></h1>
        </div>
                ...
                <div class="posts_child">
                    ...
                    <div class="post_text_content">
                        ...
                        <div class="post_date_author">
                            ...
                            <span><a href="<?php echo esc_url(get_author_posts_url($author_id)); ?>"><?php echo $author_name; ?></a></span>
                        </div>
